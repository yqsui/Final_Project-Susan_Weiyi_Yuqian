...
\begin{figure}[H]
\centering
\includegraphics[width=0.70\textwidth,keepaspectratio]{../data/derived-data/scatter_plot.png}
\end{figure}
```
...
\begin{figure}[H]
\centering
\includegraphics[width=0.80\textwidth,keepaspectratio]{../data/derived-data/regression_matrix.png}
\end{figure}
```
